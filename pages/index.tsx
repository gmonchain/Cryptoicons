...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 shadow-inner"> {/* Main container with gradient background and subtle shadow */}
