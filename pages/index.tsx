  ...
  if (loading) { // Displays a loading spinner while fetching icons
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center"> {/* Centered container for loading elements */}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center max-w-md"> {/* Centered container for error message */}
          <div className="bg-red-100 rounded-full p-3 w-16 h-16 mx-auto mb-4 flex items-center justify-center"> {/* Styling for the warning icon container */}
            <span className="text-red-600 text-2xl">⚠️</span> {/* Warning emoji icon */}
          </div>
