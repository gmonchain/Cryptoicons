...
import { SearchBar } from '../components/SearchBar'; // Imports the SearchBar component for user input
import { Stats } from '../components/Stats'; // Imports the Stats component to display icon counts
